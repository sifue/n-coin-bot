...
const chargeFreeMaxBalance = 20; // 手数料ゼロ最高残高 (以下の場合は逆にサービス)

/**
 * 賞金から差し引く手数料割合の計算関数
 * (残高 - 手数料ゼロ最大残高) / ジャンケン可能最高残高
 * 残高20の時、(20 - 20) / 500 = 0 / 100 = 0%
 * 残高150の時、(150 - 20) / 500 = 26 / 100 = 26%
 * 残高500の時、 (500 - 20) / 500 = 96 / 100 = 98%
 ...
 * 残高1の時、 (20 - 1) / 20  + 1 = 195 / 100 = 195%
 * 残高10の時、 (20 - 10) / 20  + 1 = 150 / 100 = 150%
 * @param {Number} balance 残高
