...
const chargeFreeMaxBalance = 10; // 手数料ゼロ最高残高 (以下の場合は逆にサービス)

/**
 * 賞金から差し引く手数料割合の計算関数
 * (残高 - 手数料ゼロ最大残高) / ジャンケン可能最高残高
 * 残高10の時、(150 - 10) / 500 = 10 / 100 = 0%
 * 残高150の時、(150 - 10) / 500 = 10 / 100 = 28%
 * 残高500の時、 (500 - 10) / 500 = 80 / 100 = 98%
 ...
 * 残高1の時、 (10 - 1) / 10  + 1 = 190 / 100 = 190%
 * 残高10の時、 (10 - 10) / 10  + 1 = 100 / 100 = 100%
 * @param {Number} balance 残高
